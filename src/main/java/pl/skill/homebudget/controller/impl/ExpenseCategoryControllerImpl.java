...
import pl.skill.homebudget.controller.ExpenseCategoryController;
...
public class ExpenseCategoryControllerImpl implements ExpenseCategoryController {
    ...
    private static final Logger log = LoggerFactory.getLogger(ExpenseCategoryControllerImpl.class);
